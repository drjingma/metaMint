...
This document introduces to you how to use the package **metaMint** for joint estimation of microbial and metabolite interaction network.
...
The model underlying **metaMint** allows for both continuous and zero-inflated variables. Therefore, to jointly estimate the microbial and metabolite interaction network, one only needs to expand the input to include both types of measurements. 
